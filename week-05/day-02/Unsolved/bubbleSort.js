...
function bubbleSort(){
  ...
  valNext = null;
    ...
    unsortedArr.forEach(function(value, index){
      if(value > unsortedArr[index + 1]){      
        unsortedArr.forEach(function(value1, index1){
          if(value1 > unsortedArr[index1 + 1]){
            valNext = unsortedArr[index1 + 1];
            unsortedArr[index1 + 1] = value1;
            unsortedArr[index1] = valNext;
          };
        });
      };
    });
